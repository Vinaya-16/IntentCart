                ...
                <div className="flex-1 min-w-0 h-full overflow-y-auto">
                    <main className="p-3.5 sm:p-6 lg:p-8 space-y-4 sm:space-y-6 max-w-7xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200/80 pb-4 sm:pb-5">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="self-start sm:self-center px-3 py-2 text-xs font-semibold bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 rounded-xl transition-all flex items-center gap-1.5 shadow-xs"
                                    title="Refresh"
                                >
                                ...
                                {unreadCount > 0 && (
                                    <button
                                        ...
                                        className="self-start sm:self-center px-3.5 py-2 text-xs font-semibold bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 rounded-xl transition-all flex items-center gap-1.5 shadow-xs"
                                    >
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden">
                            ...
                            {/* SEARCH & CATEGORY BAR */}
                            <div className="sticky top-0 z-10 bg-white/95 backdrop-blur-md p-3.5 sm:p-5 border-b border-slate-200/80 space-y-3 sm:space-y-4">
                                    ...
                                    filteredNotifs.map((notif) => {
                                        ...
                                        return (
                                            <div
                                                ...
                                                className={`p-3.5 sm:p-5 flex items-start gap-3.5 sm:gap-4 hover:bg-slate-50/80 transition-colors cursor-pointer group relative ${notif.isUnread ? 'bg-slate-50/40' : 'bg-white'
                                                    }`}
                                            >
                                                ...
                                                <button
                                                    ...
                                                    className="p-1.5 text-slate-300 hover:text-rose-600 hover:bg-rose-50 rounded-lg transition-all opacity-0 group-hover:opacity-100 shrink-0 self-center disabled:opacity-50"
                                                    title="Dismiss Alert"
                                                >
                                                    {isActionLoading ? (
                    ...
                    <div className="bg-white rounded-2xl sm:rounded-3xl max-w-md w-full max-h-[90vh] flex flex-col overflow-hidden shadow-2xl border border-slate-100 animate-in fade-in zoom-in-95 duration-150">
                        ...
                        <div className="p-4 sm:p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50 shrink-0">
                            <div className="flex items-center gap-2.5">
                                <div className={`p-2 rounded-xl ${NOTIF_CONFIG[selectedNotif.type]?.bg || 'bg-slate-50'} ${NOTIF_CONFIG[selectedNotif.type]?.text || 'text-slate-700'}`}>
